    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4">
            ...
            <div style="display: flex">
                ...
                <a href="/admin/contact-request" style="margin: 0 5px; color: blue;">Вопросы/Благодарности</a>
            </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="border px-4 py-2">
                            ...
                            <button wire:click="delete({{ $contact->id }})" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" style="margin-top: 5px">Удалить</button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
